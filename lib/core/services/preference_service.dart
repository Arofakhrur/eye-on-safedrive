...
class PreferenceService {
  ...
  double get earThreshold => _prefs.getDouble(_keyEarThreshold) ?? DetectionConfig.defaultEarThreshold;
  ...
  Future<void> setAlarmEnabled(bool value) =>
      _prefs.setBool(_keyIsAlarmEnabled, value);

  String get alarmSound => _prefs.getString(_keyAlarmSound) ?? 'Sound 1';
  Future<void> setAlarmSound(String value) =>
      _prefs.setString(_keyAlarmSound, value);
